...
typedef enum {FunOf_M_PASS = 0, VarOf_M_PASS = 1, Data_M_SECOND, Data_M_FIRST} EnumOf_M_PASS;
...
typedef enum {FunOf_M_Pattern_Stage = 0, VarOf_M_Pattern_Stage = 1, Data_M_MATCH, Data_M_SUBMATCH, Data_M_DISPATCH, Data_M_CASE} EnumOf_M_Pattern_Stage;
...
typedef enum {FunOf_M_Reified_xBinder = 0, VarOf_M_Reified_xBinder = 1, Data_M_BINDER, Data_M_META_REQUIRED_VARIABLE, Data_M_ARGUMENT} EnumOf_M_Reified_xBinder;
#define STRUCT_Con_M_BINDER struct _Con_M_BINDER
struct _Con_M_BINDER {struct _Construction construction; Term sub[6]; Variable binder[1];};
...
/* DATA SORT Reified_Depth HEADER DECLARATIONS. */
typedef enum {FunOf_M_Reified_xDepth = 0, VarOf_M_Reified_xDepth = 1, Data_M_SHALLOW, Data_M_DEEP} EnumOf_M_Reified_xDepth;
#define STRUCT_Con_M_SHALLOW struct _ConstantConstruction
extern struct _ConstructionDescriptor descriptor_M_SHALLOW;
#define STRUCT_Con_M_DEEP struct _ConstantConstruction
extern struct _ConstructionDescriptor descriptor_M_DEEP;
extern struct _SortDescriptor sort_M_Reified_xDepth;

/* DATA SORT Reified_Form HEADER DECLARATIONS. */
typedef enum {FunOf_M_Reified_xForm = 0, VarOf_M_Reified_xForm = 1, Data_M_SORT_ALLOWS_VARIABLES, Data_M_FORM, Data_M_SORT_SET} EnumOf_M_Reified_xForm;
...
struct _Con_M_FORM_BINDER {struct _Construction construction; Term sub[3]; Variable binder[1];};
...
/* DATA SORT Reified_Kind HEADER DECLARATIONS. */
typedef enum {FunOf_M_Reified_xKind = 0, VarOf_M_Reified_xKind = 1, Data_M_KDATA, Data_M_KFUNCTION} EnumOf_M_Reified_xKind;
#define STRUCT_Con_M_KDATA struct _ConstantConstruction
extern struct _ConstructionDescriptor descriptor_M_KDATA;
#define STRUCT_Con_M_KFUNCTION struct _ConstantConstruction
extern struct _ConstructionDescriptor descriptor_M_KFUNCTION;
extern struct _SortDescriptor sort_M_Reified_xKind;
...
typedef enum {FunOf_M_Reified_xTerm = 0, VarOf_M_Reified_xTerm = 1, Data_M_META_APPLICATION, Data_M_EVALUATOR, Data_M_CONSTRUCTION, Data_M_LITERAL, Data_M_PROPERTY, Data_M_FreshReuseOrigin, Data_M_PROPERTY_NOT, Data_M_VARIABLE_USE, Data_M_PROPERTY_REF} EnumOf_M_Reified_xTerm;
...
struct _Con_M_CONSTRUCTION {struct _Construction construction; Term sub[3]; Variable binder[0];};
...
struct _Con_M_PROPERTY_REF {struct _Construction construction; Term sub[3]; Variable binder[0];};
...
typedef enum {FunOf_M_Reified_xUse = 0, VarOf_M_Reified_xUse = 1, Data_M_USE, Data_M_DISCARD, Data_M_NA} EnumOf_M_Reified_xUse;
...
typedef enum {FunOf_M_SPrimitive = 0, VarOf_M_SPrimitive = 1, Data_M_E_xMod, Data_M_E_xIfEmpty, Data_M_E_xMangle, Data_M_E_xExceptVariables, Data_M_E_xGetRef, Data_M_E_xAfterFirst, Data_M_E_xUnionVariables, Data_M_E_xSaveTerm, Data_M_E_xCast, Data_M_E_xFromFirst, Data_M_E_xKeys, Data_M_E_xUpCase, Data_M_E_xLessThan, Data_M_E_xAbsolute, Data_M_E_xBitMinus, Data_M_E_xBitOr, Data_M_E_xParseText, Data_M_E_xIsEmpty, Data_M_E_xLength, Data_M_E_xBitXOr, Data_M_E_xCall, Data_M_E_xBitNot, Data_M_E_xFormat, Data_M_E_xElapsedTime, Data_M_E_xPassLocationProperties, Data_M_E_xLessThanOrEqual, Data_M_E_xGreaterThanOrEqual, Data_M_E_xC, Data_M_E_xShow, Data_M_E_xDownCase, Data_M_E_xReversePick, Data_M_E_xIfDef, Data_M_E_xFormatNumber, Data_M_E_xNumericEqual, Data_M_E_xEcho, Data_M_E_xConcat, Data_M_E_xMinus, Data_M_E_xTrace, Data_M_E_xIntersectVariables, Data_M_E_xStartsWith, Data_M_E_xEncodePoint, Data_M_E_xListLength, Data_M_E_xNull, Data_M_E_xSymbol, Data_M_E_xNil, Data_M_E_xProfileEnter, Data_M_E_xToFirst, Data_M_E_xTimes, Data_M_E_xReplace, Data_M_E_xLesserVariable, Data_M_E_xPlus, Data_M_E_xPick, Data_M_E_xLoadTerm, Data_M_E_xSquash, Data_M_E_xBitAnd, Data_M_E_xStringLessThan, Data_M_E_xTrim, Data_M_E_xBeforeFirst, Data_M_E_xSameVariable, Data_M_E_xFreeVariables, Data_M_E_xParseURL, Data_M_E_xTryCall, Data_M_E_xMatch, Data_M_E_xBitSubSetEq, Data_M_E_xError, Data_M_E_xDump, Data_M_E_xHashCode, Data_M_E_xMatchRegex, Data_M_E_xDecimal, Data_M_E_xIndex, Data_M_E_xEscape, Data_M_E_xContains, Data_M_E_xIfZero, Data_M_E_xHex, Data_M_E_xDiv, Data_M_E_xProfileExit, Data_M_E_xEqual, Data_M_E_xRescape, Data_M_E_xDeepEqual, Data_M_E_xGet, Data_M_E_xGreaterThan, Data_M_E_xEndsWith, Data_M_E_xNotEqual, Data_M_E_xSubstring, Data_M_E_xIsZero, Data_M_E_xSplit, Data_M_E_xVariableNameIs, Data_M_E_xIf, Data_M_E_xForgivableError} EnumOf_M_SPrimitive;
...
#define STRUCT_Con_M_E_xParseText struct _ConstantConstruction
extern struct _ConstructionDescriptor descriptor_M_E_xParseText;
...
#define STRUCT_Con_M_E_xElapsedTime struct _ConstantConstruction
extern struct _ConstructionDescriptor descriptor_M_E_xElapsedTime;
...
#define STRUCT_Con_M_E_xReversePick struct _ConstantConstruction
extern struct _ConstructionDescriptor descriptor_M_E_xReversePick;
...
#define STRUCT_Con_M_E_xEncodePoint struct _ConstantConstruction
extern struct _ConstructionDescriptor descriptor_M_E_xEncodePoint;
#define STRUCT_Con_M_E_xListLength struct _ConstantConstruction
extern struct _ConstructionDescriptor descriptor_M_E_xListLength;
#define STRUCT_Con_M_E_xNull struct _ConstantConstruction
extern struct _ConstructionDescriptor descriptor_M_E_xNull;
#define STRUCT_Con_M_E_xSymbol struct _ConstantConstruction
extern struct _ConstructionDescriptor descriptor_M_E_xSymbol;
#define STRUCT_Con_M_E_xNil struct _ConstantConstruction
extern struct _ConstructionDescriptor descriptor_M_E_xNil;
#define STRUCT_Con_M_E_xProfileEnter struct _ConstantConstruction
extern struct _ConstructionDescriptor descriptor_M_E_xProfileEnter;
...
#define STRUCT_Con_M_E_xPick struct _ConstantConstruction
extern struct _ConstructionDescriptor descriptor_M_E_xPick;
...
#define STRUCT_Con_M_E_xDump struct _ConstantConstruction
extern struct _ConstructionDescriptor descriptor_M_E_xDump;
...
#define STRUCT_Con_M_E_xIndex struct _ConstantConstruction
extern struct _ConstructionDescriptor descriptor_M_E_xIndex;
...
#define STRUCT_Con_M_E_xProfileExit struct _ConstantConstruction
extern struct _ConstructionDescriptor descriptor_M_E_xProfileExit;
...
typedef enum {FunOf_M_STRING_xENTRY = 0, VarOf_M_STRING_xENTRY = 1, Data_M_YES, Data_M_NUM_xVALUE, Data_M_ARG_xSORT, Data_M_LIST_xSTRING, Data_M_VARIABLE, Data_M_TEXT, Data_M_LIST_xVARIABLE, Data_M_STRING_xVALUE, Data_M_PROPERTY_xVARIABLE, Data_M_NO} EnumOf_M_STRING_xENTRY;
#define STRUCT_Con_M_YES struct _ConstantConstruction
extern struct _ConstructionDescriptor descriptor_M_YES;
...
#define STRUCT_Con_M_ARG_xSORT struct _Con_M_ARG_xSORT
struct _Con_M_ARG_xSORT {struct _Construction construction; Term sub[1]; Variable binder[0];};
extern struct _ConstructionDescriptor descriptor_M_ARG_xSORT;
...
#define STRUCT_Con_M_TEXT struct _Con_M_TEXT
struct _Con_M_TEXT {struct _Construction construction; Term sub[1]; Variable binder[0];};
extern struct _ConstructionDescriptor descriptor_M_TEXT;
...
typedef enum {FunOf_M_VARIABLE_xENTRY = 0, VarOf_M_VARIABLE_xENTRY = 1, Data_M_BOUND_xDATA, Data_M_FREE, Data_M_BOUNDREUSE, Data_M_SUB, Data_M_FRESH, Data_M_ARG, Data_M_FRESHREUSE, Data_M_BOUND} EnumOf_M_VARIABLE_xENTRY;
#define STRUCT_Con_M_BOUND_xDATA struct _ConstantConstruction
extern struct _ConstructionDescriptor descriptor_M_BOUND_xDATA;
...
#define STRUCT_Con_M_ARG struct _Con_M_ARG
struct _Con_M_ARG {struct _Construction construction; Term sub[2]; Variable binder[0];};
extern struct _ConstructionDescriptor descriptor_M_ARG;
