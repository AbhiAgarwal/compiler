...
ConstructionDescriptor sortCon_M_PASS[] = {NULL, NULL, &descriptor_M_SECOND, &descriptor_M_FIRST,  NULL};
char *sortNam_M_PASS[] = {NULL, NULL,  "SECOND" ,  "FIRST" ,  NULL};
char *sortInt_M_PASS[] = {NULL, NULL, "_M_SECOND", "_M_FIRST",  NULL};
...
ConstructionDescriptor sortCon_M_Pattern_Stage[] = {NULL, NULL, &descriptor_M_MATCH, &descriptor_M_SUBMATCH, &descriptor_M_DISPATCH, &descriptor_M_CASE,  NULL};
char *sortNam_M_Pattern_Stage[] = {NULL, NULL,  "MATCH" ,  "SUBMATCH" ,  "DISPATCH" ,  "CASE" ,  NULL};
char *sortInt_M_Pattern_Stage[] = {NULL, NULL, "_M_MATCH", "_M_SUBMATCH", "_M_DISPATCH", "_M_CASE",  NULL};
...
int conBindOffs_M_BINDER[] = {0 , 0 , 0 , 0 , 0 , 0 , 1};
char *name_M_BINDER =  "BINDER" ;
char *nameFun_M_BINDER(Term term) { return name_M_BINDER; }
struct _ConstructionDescriptor descriptor_M_BINDER = {&sort_M_Reified_xBinder, Data_M_BINDER, 6, sizeof(STRUCT_Con_M_BINDER), conBindOffs_M_BINDER, &nameFun_M_BINDER, &dataStep};
...
ConstructionDescriptor sortCon_M_Reified_xBinder[] = {NULL, NULL, &descriptor_M_BINDER, &descriptor_M_META_REQUIRED_VARIABLE, &descriptor_M_ARGUMENT,  NULL};
char *sortNam_M_Reified_xBinder[] = {NULL, NULL,  "BINDER" ,  "META-REQUIRED-VARIABLE" ,  "ARGUMENT" ,  NULL};
char *sortInt_M_Reified_xBinder[] = {NULL, NULL, "_M_BINDER", "_M_META_REQUIRED_VARIABLE", "_M_ARGUMENT",  NULL};
...
/* SORT Reified_Depth CONSTANTS. */
char *name_M_SHALLOW =  "SHALLOW" ;
char *nameFun_M_SHALLOW(Term term) { return name_M_SHALLOW; }
struct _ConstructionDescriptor descriptor_M_SHALLOW = {&sort_M_Reified_xDepth, Data_M_SHALLOW, 0, sizeof(STRUCT_Con_M_SHALLOW), noBinderOffsets, &nameFun_M_SHALLOW, &dataStep};
char *name_M_DEEP =  "DEEP" ;
char *nameFun_M_DEEP(Term term) { return name_M_DEEP; }
struct _ConstructionDescriptor descriptor_M_DEEP = {&sort_M_Reified_xDepth, Data_M_DEEP, 0, sizeof(STRUCT_Con_M_DEEP), noBinderOffsets, &nameFun_M_DEEP, &dataStep};
ConstructionDescriptor sortCon_M_Reified_xDepth[] = {NULL, NULL, &descriptor_M_SHALLOW, &descriptor_M_DEEP,  NULL};
char *sortNam_M_Reified_xDepth[] = {NULL, NULL,  "SHALLOW" ,  "DEEP" ,  NULL};
char *sortInt_M_Reified_xDepth[] = {NULL, NULL, "_M_SHALLOW", "_M_DEEP",  NULL};
struct _SortDescriptor sort_M_Reified_xDepth = { "Reified_Depth" , sortCon_M_Reified_xDepth, sortNam_M_Reified_xDepth, sortInt_M_Reified_xDepth, NULL};
...
ConstructionDescriptor sortCon_M_Reified_xForm[] = {NULL, NULL, &descriptor_M_SORT_ALLOWS_VARIABLES, &descriptor_M_FORM, &descriptor_M_SORT_SET,  NULL};
char *sortNam_M_Reified_xForm[] = {NULL, NULL,  "SORT-ALLOWS-VARIABLES" ,  "FORM" ,  "SORT-SET" ,  NULL};
char *sortInt_M_Reified_xForm[] = {NULL, NULL, "_M_SORT_ALLOWS_VARIABLES", "_M_FORM", "_M_SORT_SET",  NULL};
...
int conBindOffs_M_FORM_BINDER[] = {0 , 0 , 0 , 1};
char *name_M_FORM_BINDER =  "FORM-BINDER" ;
char *nameFun_M_FORM_BINDER(Term term) { return name_M_FORM_BINDER; }
struct _ConstructionDescriptor descriptor_M_FORM_BINDER = {&sort_M_Reified_xFormArgument, Data_M_FORM_BINDER, 3, sizeof(STRUCT_Con_M_FORM_BINDER), conBindOffs_M_FORM_BINDER, &nameFun_M_FORM_BINDER, &dataStep};
...
/* SORT Reified_Kind CONSTANTS. */
char *name_M_KDATA =  "KDATA" ;
char *nameFun_M_KDATA(Term term) { return name_M_KDATA; }
struct _ConstructionDescriptor descriptor_M_KDATA = {&sort_M_Reified_xKind, Data_M_KDATA, 0, sizeof(STRUCT_Con_M_KDATA), noBinderOffsets, &nameFun_M_KDATA, &dataStep};
char *name_M_KFUNCTION =  "KFUNCTION" ;
char *nameFun_M_KFUNCTION(Term term) { return name_M_KFUNCTION; }
struct _ConstructionDescriptor descriptor_M_KFUNCTION = {&sort_M_Reified_xKind, Data_M_KFUNCTION, 0, sizeof(STRUCT_Con_M_KFUNCTION), noBinderOffsets, &nameFun_M_KFUNCTION, &dataStep};
ConstructionDescriptor sortCon_M_Reified_xKind[] = {NULL, NULL, &descriptor_M_KDATA, &descriptor_M_KFUNCTION,  NULL};
char *sortNam_M_Reified_xKind[] = {NULL, NULL,  "KDATA" ,  "KFUNCTION" ,  NULL};
char *sortInt_M_Reified_xKind[] = {NULL, NULL, "_M_KDATA", "_M_KFUNCTION",  NULL};
struct _SortDescriptor sort_M_Reified_xKind = { "Reified_Kind" , sortCon_M_Reified_xKind, sortNam_M_Reified_xKind, sortInt_M_Reified_xKind, NULL};
...
int conBindOffs_M_CONSTRUCTION[] = {0 , 0 , 0 , 0};
char *name_M_CONSTRUCTION =  "CONSTRUCTION" ;
char *nameFun_M_CONSTRUCTION(Term term) { return name_M_CONSTRUCTION; }
struct _ConstructionDescriptor descriptor_M_CONSTRUCTION = {&sort_M_Reified_xTerm, Data_M_CONSTRUCTION, 3, sizeof(STRUCT_Con_M_CONSTRUCTION), conBindOffs_M_CONSTRUCTION, &nameFun_M_CONSTRUCTION, &dataStep};
...
int conBindOffs_M_PROPERTY_REF[] = {0 , 0 , 0 , 0};
char *name_M_PROPERTY_REF =  "PROPERTY-REF" ;
char *nameFun_M_PROPERTY_REF(Term term) { return name_M_PROPERTY_REF; }
struct _ConstructionDescriptor descriptor_M_PROPERTY_REF = {&sort_M_Reified_xTerm, Data_M_PROPERTY_REF, 3, sizeof(STRUCT_Con_M_PROPERTY_REF), conBindOffs_M_PROPERTY_REF, &nameFun_M_PROPERTY_REF, &dataStep};
ConstructionDescriptor sortCon_M_Reified_xTerm[] = {NULL, NULL, &descriptor_M_META_APPLICATION, &descriptor_M_EVALUATOR, &descriptor_M_CONSTRUCTION, &descriptor_M_LITERAL, &descriptor_M_PROPERTY, &descriptor_M_FreshReuseOrigin, &descriptor_M_PROPERTY_NOT, &descriptor_M_VARIABLE_USE, &descriptor_M_PROPERTY_REF,  NULL};
char *sortNam_M_Reified_xTerm[] = {NULL, NULL,  "META-APPLICATION" ,  "EVALUATOR" ,  "CONSTRUCTION" ,  "LITERAL" ,  "PROPERTY" ,  "FreshReuseOrigin" ,  "PROPERTY-NOT" ,  "VARIABLE-USE" ,  "PROPERTY-REF" ,  NULL};
char *sortInt_M_Reified_xTerm[] = {NULL, NULL, "_M_META_APPLICATION", "_M_EVALUATOR", "_M_CONSTRUCTION", "_M_LITERAL", "_M_PROPERTY", "_M_FreshReuseOrigin", "_M_PROPERTY_NOT", "_M_VARIABLE_USE", "_M_PROPERTY_REF",  NULL};
...
ConstructionDescriptor sortCon_M_Reified_xUse[] = {NULL, NULL, &descriptor_M_USE, &descriptor_M_DISCARD, &descriptor_M_NA,  NULL};
char *sortNam_M_Reified_xUse[] = {NULL, NULL,  "USE" ,  "DISCARD" ,  "NA" ,  NULL};
char *sortInt_M_Reified_xUse[] = {NULL, NULL, "_M_USE", "_M_DISCARD", "_M_NA",  NULL};
...
char *name_M_E_xParseText =  "E_ParseText" ;
char *nameFun_M_E_xParseText(Term term) { return name_M_E_xParseText; }
struct _ConstructionDescriptor descriptor_M_E_xParseText = {&sort_M_SPrimitive, Data_M_E_xParseText, 0, sizeof(STRUCT_Con_M_E_xParseText), noBinderOffsets, &nameFun_M_E_xParseText, &dataStep};
...
char *name_M_E_xElapsedTime =  "E_ElapsedTime" ;
char *nameFun_M_E_xElapsedTime(Term term) { return name_M_E_xElapsedTime; }
struct _ConstructionDescriptor descriptor_M_E_xElapsedTime = {&sort_M_SPrimitive, Data_M_E_xElapsedTime, 0, sizeof(STRUCT_Con_M_E_xElapsedTime), noBinderOffsets, &nameFun_M_E_xElapsedTime, &dataStep};
...
char *name_M_E_xReversePick =  "E_ReversePick" ;
char *nameFun_M_E_xReversePick(Term term) { return name_M_E_xReversePick; }
struct _ConstructionDescriptor descriptor_M_E_xReversePick = {&sort_M_SPrimitive, Data_M_E_xReversePick, 0, sizeof(STRUCT_Con_M_E_xReversePick), noBinderOffsets, &nameFun_M_E_xReversePick, &dataStep};
...
char *name_M_E_xEncodePoint =  "E_EncodePoint" ;
char *nameFun_M_E_xEncodePoint(Term term) { return name_M_E_xEncodePoint; }
struct _ConstructionDescriptor descriptor_M_E_xEncodePoint = {&sort_M_SPrimitive, Data_M_E_xEncodePoint, 0, sizeof(STRUCT_Con_M_E_xEncodePoint), noBinderOffsets, &nameFun_M_E_xEncodePoint, &dataStep};
char *name_M_E_xListLength =  "E_ListLength" ;
char *nameFun_M_E_xListLength(Term term) { return name_M_E_xListLength; }
struct _ConstructionDescriptor descriptor_M_E_xListLength = {&sort_M_SPrimitive, Data_M_E_xListLength, 0, sizeof(STRUCT_Con_M_E_xListLength), noBinderOffsets, &nameFun_M_E_xListLength, &dataStep};
...
char *name_M_E_xSymbol =  "E_Symbol" ;
char *nameFun_M_E_xSymbol(Term term) { return name_M_E_xSymbol; }
struct _ConstructionDescriptor descriptor_M_E_xSymbol = {&sort_M_SPrimitive, Data_M_E_xSymbol, 0, sizeof(STRUCT_Con_M_E_xSymbol), noBinderOffsets, &nameFun_M_E_xSymbol, &dataStep};
...
char *name_M_E_xProfileEnter =  "E_ProfileEnter" ;
char *nameFun_M_E_xProfileEnter(Term term) { return name_M_E_xProfileEnter; }
struct _ConstructionDescriptor descriptor_M_E_xProfileEnter = {&sort_M_SPrimitive, Data_M_E_xProfileEnter, 0, sizeof(STRUCT_Con_M_E_xProfileEnter), noBinderOffsets, &nameFun_M_E_xProfileEnter, &dataStep};
...
char *name_M_E_xPick =  "E_Pick" ;
char *nameFun_M_E_xPick(Term term) { return name_M_E_xPick; }
struct _ConstructionDescriptor descriptor_M_E_xPick = {&sort_M_SPrimitive, Data_M_E_xPick, 0, sizeof(STRUCT_Con_M_E_xPick), noBinderOffsets, &nameFun_M_E_xPick, &dataStep};
...
char *name_M_E_xDump =  "E_Dump" ;
char *nameFun_M_E_xDump(Term term) { return name_M_E_xDump; }
struct _ConstructionDescriptor descriptor_M_E_xDump = {&sort_M_SPrimitive, Data_M_E_xDump, 0, sizeof(STRUCT_Con_M_E_xDump), noBinderOffsets, &nameFun_M_E_xDump, &dataStep};
...
char *name_M_E_xIndex =  "E_Index" ;
char *nameFun_M_E_xIndex(Term term) { return name_M_E_xIndex; }
struct _ConstructionDescriptor descriptor_M_E_xIndex = {&sort_M_SPrimitive, Data_M_E_xIndex, 0, sizeof(STRUCT_Con_M_E_xIndex), noBinderOffsets, &nameFun_M_E_xIndex, &dataStep};
...
char *name_M_E_xProfileExit =  "E_ProfileExit" ;
char *nameFun_M_E_xProfileExit(Term term) { return name_M_E_xProfileExit; }
struct _ConstructionDescriptor descriptor_M_E_xProfileExit = {&sort_M_SPrimitive, Data_M_E_xProfileExit, 0, sizeof(STRUCT_Con_M_E_xProfileExit), noBinderOffsets, &nameFun_M_E_xProfileExit, &dataStep};
...
ConstructionDescriptor sortCon_M_SPrimitive[] = {NULL, NULL, &descriptor_M_E_xMod, &descriptor_M_E_xIfEmpty, &descriptor_M_E_xMangle, &descriptor_M_E_xExceptVariables, &descriptor_M_E_xGetRef, &descriptor_M_E_xAfterFirst, &descriptor_M_E_xUnionVariables, &descriptor_M_E_xSaveTerm, &descriptor_M_E_xCast, &descriptor_M_E_xFromFirst, &descriptor_M_E_xKeys, &descriptor_M_E_xUpCase, &descriptor_M_E_xLessThan, &descriptor_M_E_xAbsolute, &descriptor_M_E_xBitMinus, &descriptor_M_E_xBitOr, &descriptor_M_E_xParseText, &descriptor_M_E_xIsEmpty, &descriptor_M_E_xLength, &descriptor_M_E_xBitXOr, &descriptor_M_E_xCall, &descriptor_M_E_xBitNot, &descriptor_M_E_xFormat, &descriptor_M_E_xElapsedTime, &descriptor_M_E_xPassLocationProperties, &descriptor_M_E_xLessThanOrEqual, &descriptor_M_E_xGreaterThanOrEqual, &descriptor_M_E_xC, &descriptor_M_E_xShow, &descriptor_M_E_xDownCase, &descriptor_M_E_xReversePick, &descriptor_M_E_xIfDef, &descriptor_M_E_xFormatNumber, &descriptor_M_E_xNumericEqual, &descriptor_M_E_xEcho, &descriptor_M_E_xConcat, &descriptor_M_E_xMinus, &descriptor_M_E_xTrace, &descriptor_M_E_xIntersectVariables, &descriptor_M_E_xStartsWith, &descriptor_M_E_xEncodePoint, &descriptor_M_E_xListLength, &descriptor_M_E_xNull, &descriptor_M_E_xSymbol, &descriptor_M_E_xNil, &descriptor_M_E_xProfileEnter, &descriptor_M_E_xToFirst, &descriptor_M_E_xTimes, &descriptor_M_E_xReplace, &descriptor_M_E_xLesserVariable, &descriptor_M_E_xPlus, &descriptor_M_E_xPick, &descriptor_M_E_xLoadTerm, &descriptor_M_E_xSquash, &descriptor_M_E_xBitAnd, &descriptor_M_E_xStringLessThan, &descriptor_M_E_xTrim, &descriptor_M_E_xBeforeFirst, &descriptor_M_E_xSameVariable, &descriptor_M_E_xFreeVariables, &descriptor_M_E_xParseURL, &descriptor_M_E_xTryCall, &descriptor_M_E_xMatch, &descriptor_M_E_xBitSubSetEq, &descriptor_M_E_xError, &descriptor_M_E_xDump, &descriptor_M_E_xHashCode, &descriptor_M_E_xMatchRegex, &descriptor_M_E_xDecimal, &descriptor_M_E_xIndex, &descriptor_M_E_xEscape, &descriptor_M_E_xContains, &descriptor_M_E_xIfZero, &descriptor_M_E_xHex, &descriptor_M_E_xDiv, &descriptor_M_E_xProfileExit, &descriptor_M_E_xEqual, &descriptor_M_E_xRescape, &descriptor_M_E_xDeepEqual, &descriptor_M_E_xGet, &descriptor_M_E_xGreaterThan, &descriptor_M_E_xEndsWith, &descriptor_M_E_xNotEqual, &descriptor_M_E_xSubstring, &descriptor_M_E_xIsZero, &descriptor_M_E_xSplit, &descriptor_M_E_xVariableNameIs, &descriptor_M_E_xIf, &descriptor_M_E_xForgivableError,  NULL};
char *sortNam_M_SPrimitive[] = {NULL, NULL,  "E_Mod" ,  "E_IfEmpty" ,  "E_Mangle" ,  "E_ExceptVariables" ,  "E_GetRef" ,  "E_AfterFirst" ,  "E_UnionVariables" ,  "E_SaveTerm" ,  "E_Cast" ,  "E_FromFirst" ,  "E_Keys" ,  "E_UpCase" ,  "E_LessThan" ,  "E_Absolute" ,  "E_BitMinus" ,  "E_BitOr" ,  "E_ParseText" ,  "E_IsEmpty" ,  "E_Length" ,  "E_BitXOr" ,  "E_Call" ,  "E_BitNot" ,  "E_Format" ,  "E_ElapsedTime" ,  "E_PassLocationProperties" ,  "E_LessThanOrEqual" ,  "E_GreaterThanOrEqual" ,  "E_C" ,  "E_Show" ,  "E_DownCase" ,  "E_ReversePick" ,  "E_IfDef" ,  "E_FormatNumber" ,  "E_NumericEqual" ,  "E_Echo" ,  "E_Concat" ,  "E_Minus" ,  "E_Trace" ,  "E_IntersectVariables" ,  "E_StartsWith" ,  "E_EncodePoint" ,  "E_ListLength" ,  "E_Null" ,  "E_Symbol" ,  "E_Nil" ,  "E_ProfileEnter" ,  "E_ToFirst" ,  "E_Times" ,  "E_Replace" ,  "E_LesserVariable" ,  "E_Plus" ,  "E_Pick" ,  "E_LoadTerm" ,  "E_Squash" ,  "E_BitAnd" ,  "E_StringLessThan" ,  "E_Trim" ,  "E_BeforeFirst" ,  "E_SameVariable" ,  "E_FreeVariables" ,  "E_ParseURL" ,  "E_TryCall" ,  "E_Match" ,  "E_BitSubSetEq" ,  "E_Error" ,  "E_Dump" ,  "E_HashCode" ,  "E_MatchRegex" ,  "E_Decimal" ,  "E_Index" ,  "E_Escape" ,  "E_Contains" ,  "E_IfZero" ,  "E_Hex" ,  "E_Div" ,  "E_ProfileExit" ,  "E_Equal" ,  "E_Rescape" ,  "E_DeepEqual" ,  "E_Get" ,  "E_GreaterThan" ,  "E_EndsWith" ,  "E_NotEqual" ,  "E_Substring" ,  "E_IsZero" ,  "E_Split" ,  "E_VariableNameIs" ,  "E_If" ,  "E_ForgivableError" ,  NULL};
char *sortInt_M_SPrimitive[] = {NULL, NULL, "_M_E_xMod", "_M_E_xIfEmpty", "_M_E_xMangle", "_M_E_xExceptVariables", "_M_E_xGetRef", "_M_E_xAfterFirst", "_M_E_xUnionVariables", "_M_E_xSaveTerm", "_M_E_xCast", "_M_E_xFromFirst", "_M_E_xKeys", "_M_E_xUpCase", "_M_E_xLessThan", "_M_E_xAbsolute", "_M_E_xBitMinus", "_M_E_xBitOr", "_M_E_xParseText", "_M_E_xIsEmpty", "_M_E_xLength", "_M_E_xBitXOr", "_M_E_xCall", "_M_E_xBitNot", "_M_E_xFormat", "_M_E_xElapsedTime", "_M_E_xPassLocationProperties", "_M_E_xLessThanOrEqual", "_M_E_xGreaterThanOrEqual", "_M_E_xC", "_M_E_xShow", "_M_E_xDownCase", "_M_E_xReversePick", "_M_E_xIfDef", "_M_E_xFormatNumber", "_M_E_xNumericEqual", "_M_E_xEcho", "_M_E_xConcat", "_M_E_xMinus", "_M_E_xTrace", "_M_E_xIntersectVariables", "_M_E_xStartsWith", "_M_E_xEncodePoint", "_M_E_xListLength", "_M_E_xNull", "_M_E_xSymbol", "_M_E_xNil", "_M_E_xProfileEnter", "_M_E_xToFirst", "_M_E_xTimes", "_M_E_xReplace", "_M_E_xLesserVariable", "_M_E_xPlus", "_M_E_xPick", "_M_E_xLoadTerm", "_M_E_xSquash", "_M_E_xBitAnd", "_M_E_xStringLessThan", "_M_E_xTrim", "_M_E_xBeforeFirst", "_M_E_xSameVariable", "_M_E_xFreeVariables", "_M_E_xParseURL", "_M_E_xTryCall", "_M_E_xMatch", "_M_E_xBitSubSetEq", "_M_E_xError", "_M_E_xDump", "_M_E_xHashCode", "_M_E_xMatchRegex", "_M_E_xDecimal", "_M_E_xIndex", "_M_E_xEscape", "_M_E_xContains", "_M_E_xIfZero", "_M_E_xHex", "_M_E_xDiv", "_M_E_xProfileExit", "_M_E_xEqual", "_M_E_xRescape", "_M_E_xDeepEqual", "_M_E_xGet", "_M_E_xGreaterThan", "_M_E_xEndsWith", "_M_E_xNotEqual", "_M_E_xSubstring", "_M_E_xIsZero", "_M_E_xSplit", "_M_E_xVariableNameIs", "_M_E_xIf", "_M_E_xForgivableError",  NULL};
...
char *name_M_YES =  "YES" ;
char *nameFun_M_YES(Term term) { return name_M_YES; }
struct _ConstructionDescriptor descriptor_M_YES = {&sort_M_STRING_xENTRY, Data_M_YES, 0, sizeof(STRUCT_Con_M_YES), noBinderOffsets, &nameFun_M_YES, &dataStep};
...
int conBindOffs_M_ARG_xSORT[] = {0 , 0};
char *name_M_ARG_xSORT =  "ARG_SORT" ;
char *nameFun_M_ARG_xSORT(Term term) { return name_M_ARG_xSORT; }
struct _ConstructionDescriptor descriptor_M_ARG_xSORT = {&sort_M_STRING_xENTRY, Data_M_ARG_xSORT, 1, sizeof(STRUCT_Con_M_ARG_xSORT), conBindOffs_M_ARG_xSORT, &nameFun_M_ARG_xSORT, &dataStep};
...
int conBindOffs_M_TEXT[] = {0 , 0};
char *name_M_TEXT =  "TEXT" ;
char *nameFun_M_TEXT(Term term) { return name_M_TEXT; }
struct _ConstructionDescriptor descriptor_M_TEXT = {&sort_M_STRING_xENTRY, Data_M_TEXT, 1, sizeof(STRUCT_Con_M_TEXT), conBindOffs_M_TEXT, &nameFun_M_TEXT, &dataStep};
...
ConstructionDescriptor sortCon_M_STRING_xENTRY[] = {NULL, NULL, &descriptor_M_YES, &descriptor_M_NUM_xVALUE, &descriptor_M_ARG_xSORT, &descriptor_M_LIST_xSTRING, &descriptor_M_VARIABLE, &descriptor_M_TEXT, &descriptor_M_LIST_xVARIABLE, &descriptor_M_STRING_xVALUE, &descriptor_M_PROPERTY_xVARIABLE, &descriptor_M_NO,  NULL};
char *sortNam_M_STRING_xENTRY[] = {NULL, NULL,  "YES" ,  "NUM_VALUE" ,  "ARG_SORT" ,  "LIST_STRING" ,  "VARIABLE" ,  "TEXT" ,  "LIST_VARIABLE" ,  "STRING_VALUE" ,  "PROPERTY_VARIABLE" ,  "NO" ,  NULL};
char *sortInt_M_STRING_xENTRY[] = {NULL, NULL, "_M_YES", "_M_NUM_xVALUE", "_M_ARG_xSORT", "_M_LIST_xSTRING", "_M_VARIABLE", "_M_TEXT", "_M_LIST_xVARIABLE", "_M_STRING_xVALUE", "_M_PROPERTY_xVARIABLE", "_M_NO",  NULL};
...
char *name_M_BOUND_xDATA =  "BOUND_DATA" ;
char *nameFun_M_BOUND_xDATA(Term term) { return name_M_BOUND_xDATA; }
struct _ConstructionDescriptor descriptor_M_BOUND_xDATA = {&sort_M_VARIABLE_xENTRY, Data_M_BOUND_xDATA, 0, sizeof(STRUCT_Con_M_BOUND_xDATA), noBinderOffsets, &nameFun_M_BOUND_xDATA, &dataStep};
...
int conBindOffs_M_ARG[] = {0 , 0 , 0};
char *name_M_ARG =  "ARG" ;
char *nameFun_M_ARG(Term term) { return name_M_ARG; }
struct _ConstructionDescriptor descriptor_M_ARG = {&sort_M_VARIABLE_xENTRY, Data_M_ARG, 2, sizeof(STRUCT_Con_M_ARG), conBindOffs_M_ARG, &nameFun_M_ARG, &dataStep};
...
ConstructionDescriptor sortCon_M_VARIABLE_xENTRY[] = {NULL, NULL, &descriptor_M_BOUND_xDATA, &descriptor_M_FREE, &descriptor_M_BOUNDREUSE, &descriptor_M_SUB, &descriptor_M_FRESH, &descriptor_M_ARG, &descriptor_M_FRESHREUSE, &descriptor_M_BOUND,  NULL};
char *sortNam_M_VARIABLE_xENTRY[] = {NULL, NULL,  "BOUND_DATA" ,  "FREE" ,  "BOUNDREUSE" ,  "SUB" ,  "FRESH" ,  "ARG" ,  "FRESHREUSE" ,  "BOUND" ,  NULL};
char *sortInt_M_VARIABLE_xENTRY[] = {NULL, NULL, "_M_BOUND_xDATA", "_M_FREE", "_M_BOUNDREUSE", "_M_SUB", "_M_FRESH", "_M_ARG", "_M_FRESHREUSE", "_M_BOUND",  NULL};
