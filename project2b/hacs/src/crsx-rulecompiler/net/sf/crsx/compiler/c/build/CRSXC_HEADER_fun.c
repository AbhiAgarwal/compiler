...
int step_M_H_Data_s2(Sink sink__V1, Term term__V2)
{
  ...
  do {
    ...
    Term sub__V3 = SUB(term__V2, 0); int sub__V3_count = term__V2_count*LINK_COUNT(sub__V3); permitUnusedInt(sub__V3_count);
    CRSX_CHECK_SORT(sink__V1->context, sub__V3, &sort_M_Reified_xSort); /* sub__V3 = &#11 */
    Term sub__V4 = SUB(term__V2, 1); int sub__V4_count = term__V2_count*LINK_COUNT(sub__V4); permitUnusedInt(sub__V4_count);
...
int step_M_H_Data_s1(Sink sink__V9, Term term__V10)
{
  ...
  do {
    ...
    /* sub__V11 = &#11 */
    Term sub__V12 = SUB(term__V10, 1); int sub__V12_count = term__V10_count*LINK_COUNT(sub__V12); permitUnusedInt(sub__V12_count);
    /* sub__V12 = &#12 */
    ...
    { START(sink__V9, _M__sTextCons);
      ...
      { START(sink__V9, _M__sTextCons);
                                      ...
                                      { START(sink__V9, _M__sTextEmbed);
                                        { START(sink__V9, _M_AsText);
                                          { START(sink__V9, _M_DEnumTag);
                                            USE(sink__V9, linkVariable(sink__V9->context, x__V16));
                                            USE(sink__V9, linkVariable(sink__V9->context, x__V17));
                                            END(sink__V9, _M_DEnumTag); }
                                          END(sink__V9, _M_AsText); }
                                        END(sink__V9, _M__sTextEmbed); }
                                        ...
                                        { START(sink__V9, _M_MapText_s1);
                                          COPY(sink__V9, sub__V13);{ Variable x__V19 = MAKE_BOUND_PROMISCUOUS_VARIABLE(sink__V9->context,"x__V19");
                                            ...
                                            { START(sink__V9, _M_H_Form);
                                              USE(sink__V9, linkVariable(sink__V9->context, x__V19));
                                              END(sink__V9, _M_H_Form); }
                                             }
        ...
        END(sink__V9, _M__sTextCons); }
      END(sink__V9, _M__sTextCons); }
    UNLINK_NamedPropertyLink(sink__V9->context, namedP__V14); 
    UNLINK_VariablePropertyLink(sink__V9->context, varP__V15);
    return 1;
  } while (0);
  return 0;
}
...
int step_M_H_Form_s2(Sink sink__V21, Term term__V22)
{
  ...
  switch (choice__V24)
  {
    case Data_M__sNil: { /* Function HEADER-H-Form-3$H-Form$2$$Nil case $Nil */
      ...
      Term sub__V25 = SUB(term__V22, 0); int sub__V25_count = term__V22_count*LINK_COUNT(sub__V25); permitUnusedInt(sub__V25_count);
      ...
      UNLINK_NamedPropertyLink(sink__V21->context, namedP__V27); 
      UNLINK_VariablePropertyLink(sink__V21->context, varP__V28);
      
      return 1;
    break; } case Data_M__sCons: { /* Function HEADER-H-Form-4$H-Form$2$$Cons case $Cons */
      ASSERT(sink__V21->context, !strcmp(SYMBOL(term__V22),  "H-Form$2" ));
      Term sub__V29 = SUB(term__V22, 0); int sub__V29_count = term__V22_count*LINK_COUNT(sub__V29); permitUnusedInt(sub__V29_count);
      ...
      UNLINK_NamedPropertyLink(sink__V21->context, namedP__V33); 
      UNLINK_VariablePropertyLink(sink__V21->context, varP__V34);
  ...
  do {
    ...
    { START(sink__V35, _M_ComputeHeader2);
      COPY(sink__V35, sub__V37);COPY(sink__V35, sub__V38);{ Term term__V41;
        { char *value__V42 = getEnvValue(sink__V35->context,  "MODULE" );
    ...
    UNLINK_NamedPropertyLink(sink__V35->context, namedP__V39); 
    UNLINK_VariablePropertyLink(sink__V35->context, varP__V40);
    return 1;
  } while (0);
  return 0;
}
...
int step_M_H_Form_s6(Sink sink__V43, Term term__V44)
{
  ...
  do {
    ...
    Term sub__V45 = SUB(term__V44, 0); int sub__V45_count = term__V44_count*LINK_COUNT(sub__V45); permitUnusedInt(sub__V45_count);
    CRSX_CHECK_SORT(sink__V43->context, sub__V45, &sort_M_Reified_xSort); /* sub__V45 = &#11 */
    Term sub__V46 = SUB(term__V44, 1); int sub__V46_count = term__V44_count*LINK_COUNT(sub__V46); permitUnusedInt(sub__V46_count);
    ...
    UNLINK_NamedPropertyLink(sink__V43->context, namedP__V48); 
    UNLINK_VariablePropertyLink(sink__V43->context, varP__V49);
    return 1;
  } while (0);
  return 0;
}
...
int step_M_H_Form_s5(Sink sink__V50, Term term__V51)
{
  ...
  do {
    ...
    { START(sink__V50, _M__sTextNil); END(sink__V50, _M__sTextNil); } UNLINK_NamedPropertyLink(sink__V50->context, namedP__V52); 
    UNLINK_VariablePropertyLink(sink__V50->context, varP__V53);
    return 1;
  } while (0);
  return 0;
}
  ...
  do {
    ...
    { START(sink__V59, _M__sTextCons);
      ...
      { START(sink__V59, _M__sTextCons);
        ...
        END(sink__V59, _M__sTextCons); }
      END(sink__V59, _M__sTextCons); }
    UNLINK_NamedPropertyLink(sink__V59->context, namedP__V64); 
    UNLINK_VariablePropertyLink(sink__V59->context, varP__V65);
    return 1;
  } while (0);
  return 0;
}
...
int step_M_H_Form(Sink sink__V66, Term term__V67)
{
  ...
  switch (choice__V69)
  {
    case Data_M_SORT_SET: { /* Function HEADER-H-Form-1$H-Form$SORT-SET case SORT-SET */
      ...
      Term sub__V70 = SUB(term__V67, 0); int sub__V70_count = term__V67_count*LINK_COUNT(sub__V70); permitUnusedInt(sub__V70_count);
      ...
      UNLINK_NamedPropertyLink(sink__V66->context, namedP__V74); 
      UNLINK_VariablePropertyLink(sink__V66->context, varP__V75);
      
      return 1;
    break; } case Data_M_SORT_ALLOWS_VARIABLES: { /* Function HEADER-H-Form-2$H-Form$SORT-ALLOWS-VARIABLES case SORT-ALLOWS-VARIABLES */
      ASSERT(sink__V66->context, !strcmp(SYMBOL(term__V67),  "H-Form" ));
      Term sub__V76 = SUB(term__V67, 0); int sub__V76_count = term__V67_count*LINK_COUNT(sub__V76); permitUnusedInt(sub__V76_count);
      ...
      UNLINK_NamedPropertyLink(sink__V66->context, namedP__V77); 
      UNLINK_VariablePropertyLink(sink__V66->context, varP__V78);
      
      return 1;
    break; } case Data_M_FORM: { /* Function HEADER-H-Form-4$H-Form$FORM case FORM */
      ASSERT(sink__V66->context, !strcmp(SYMBOL(term__V67),  "H-Form" ));
      Term sub__V79 = SUB(term__V67, 0); int sub__V79_count = term__V67_count*LINK_COUNT(sub__V79); permitUnusedInt(sub__V79_count);
      ...
      UNLINK_NamedPropertyLink(sink__V66->context, namedP__V82); 
      UNLINK_VariablePropertyLink(sink__V66->context, varP__V83);
...
int step_M_ComputeHeader(Sink sink__V84, Term term__V85)
{
  ...
  switch (choice__V87)
  {
    case Data_M_CRSX: { /* Function HEADER-ComputeHeader-1$ComputeHeader$CRSX case CRSX */
      ...
      Term sub__V88 = SUB(term__V85, 0); int sub__V88_count = term__V85_count*LINK_COUNT(sub__V88); permitUnusedInt(sub__V88_count);
      ...
      UNLINK_NamedPropertyLink(sink__V84->context, namedP__V91); 
      UNLINK_VariablePropertyLink(sink__V84->context, varP__V92);
...
int step_M_H_Declaration(Sink sink__V93, Term term__V94)
{
  ...
  switch (choice__V96)
  {
    case Data_M_DATA: { /* Function HEADER-Data$H-Declaration$DATA case DATA */
      ...
      Term sub__V97 = SUB(term__V94, 0); int sub__V97_count = term__V94_count*LINK_COUNT(sub__V97); permitUnusedInt(sub__V97_count);
      ...
      UNLINK_NamedPropertyLink(sink__V93->context, namedP__V100); 
      UNLINK_VariablePropertyLink(sink__V93->context, varP__V101);
      
      return 1;
    break; } case Data_M_FUNCTION: { /* Function HEADER-Function$H-Declaration$FUNCTION case FUNCTION */
      ASSERT(sink__V93->context, !strcmp(SYMBOL(term__V94),  "H-Declaration" ));
      Term sub__V102 = SUB(term__V94, 0); int sub__V102_count = term__V94_count*LINK_COUNT(sub__V102); permitUnusedInt(sub__V102_count);
      ...
      UNLINK_NamedPropertyLink(sink__V93->context, namedP__V110); 
      UNLINK_VariablePropertyLink(sink__V93->context, varP__V111);
      
      return 1;
    break; } case Data_M_POLYMORPHIC: { /* Function HEADER-Polymorphic$H-Declaration$POLYMORPHIC case POLYMORPHIC */
      ASSERT(sink__V93->context, !strcmp(SYMBOL(term__V94),  "H-Declaration" ));
      Term sub__V112 = SUB(term__V94, 0); int sub__V112_count = term__V94_count*LINK_COUNT(sub__V112); permitUnusedInt(sub__V112_count);
      ...
      Variable y__V113 = linkVariable(sink__V93->context, BINDER(sub__V112,0,0)); if (sub__V112_count <= 1) UNBIND(y__V113);
      ...
      { START(sink__V93, _M_H_Declaration_s3);
        { if (!IS_BOUND(y__V113)) { REBIND(linkVariable(sink__V93->context, y__V113));
      ...
      UNLINK_NamedPropertyLink(sink__V93->context, namedP__V115); 
      UNLINK_VariablePropertyLink(sink__V93->context, varP__V116); unlinkVariable(sink__V93->context, y__V113);
...
int step_M_H_Declarations(Sink sink__V125, Term term__V126)
{
  ...
  switch (choice__V128)
  {
    case Data_M__sCons: { /* Function HEADER-H-Declarations-1$H-Declarations$$Cons case $Cons */
      ...
      Term sub__V129 = SUB(term__V126, 0); int sub__V129_count = term__V126_count*LINK_COUNT(sub__V129); permitUnusedInt(sub__V129_count);
      ...
      UNLINK_NamedPropertyLink(sink__V125->context, namedP__V132); 
      UNLINK_VariablePropertyLink(sink__V125->context, varP__V133);
      
      return 1;
    break; } case Data_M__sNil: { /* Function HEADER-H-Declarations-2$H-Declarations$$Nil case $Nil */
      ASSERT(sink__V125->context, !strcmp(SYMBOL(term__V126),  "H-Declarations" ));
      Term sub__V134 = SUB(term__V126, 0); int sub__V134_count = term__V126_count*LINK_COUNT(sub__V134); permitUnusedInt(sub__V134_count);
      ...
      UNLINK_NamedPropertyLink(sink__V125->context, namedP__V135); 
      UNLINK_VariablePropertyLink(sink__V125->context, varP__V136);
...
int step_M_H_Declarations_s2(Sink sink__V137, Term term__V138)
{
  ...
  do {
    ...
    UNLINK_NamedPropertyLink(sink__V137->context, namedP__V139); 
    UNLINK_VariablePropertyLink(sink__V137->context, varP__V140);
    return 1;
  } while (0);
  return 0;
}
...
int step_M_H_Declarations_s1(Sink sink__V141, Term term__V142)
{
  ...
  do {
    ...
    { START(sink__V141, _M__sTextCons);
      ...
      END(sink__V141, _M__sTextCons); }
    UNLINK_NamedPropertyLink(sink__V141->context, namedP__V145); 
    UNLINK_VariablePropertyLink(sink__V141->context, varP__V146);
    return 1;
  } while (0);
  return 0;
}
...
int step_M_H_Data(Sink sink__V147, Term term__V148)
{
  ...
  switch (choice__V150)
  {
    case Data_M_SORT: { /* Function HEADER-H-Data-1$H-Data$SORT case SORT */
      ...
      Term sub__V151 = SUB(term__V148, 0); int sub__V151_count = term__V148_count*LINK_COUNT(sub__V151); permitUnusedInt(sub__V151_count);
      ...
      UNLINK_NamedPropertyLink(sink__V147->context, namedP__V155); 
      UNLINK_VariablePropertyLink(sink__V147->context, varP__V156);
      
      return 1;
    break; } case Data_M_SORT_PROPERTY: { /* Function HEADER-H-Data-2$H-Data$SORT-PROPERTY case SORT-PROPERTY */
      ASSERT(sink__V147->context, !strcmp(SYMBOL(term__V148),  "H-Data" ));
      Term sub__V157 = SUB(term__V148, 0); int sub__V157_count = term__V148_count*LINK_COUNT(sub__V157); permitUnusedInt(sub__V157_count);
      ...
      UNLINK_NamedPropertyLink(sink__V147->context, namedP__V162); 
      UNLINK_VariablePropertyLink(sink__V147->context, varP__V163);
...
int step_M_H_Declaration_s3(Sink sink__V164, Term term__V165)
{
  ...
  do {
    ...
    Variable x__V166 = linkVariable(sink__V164->context, BINDER(term__V165,0,0)); if (term__V165_count <= 1) UNBIND(x__V166);
    ...
    UNLINK_NamedPropertyLink(sink__V164->context, namedP__V169); 
    UNLINK_VariablePropertyLink(sink__V164->context, varP__V170); unlinkVariable(sink__V164->context, x__V166);
    return 1;
  } while (0);
  return 0;
}
...
int step_M_H_Declaration_s2(Sink sink__V171, Term term__V172)
{
  ...
  do {
    ...
    /* sub__V174 = &#12 */
    Term sub__V175 = SUB(term__V172, 2); int sub__V175_count = term__V172_count*LINK_COUNT(sub__V175); permitUnusedInt(sub__V175_count);
    /* sub__V175 = &#13 */
    ...
    { char *value__V182 = getenv( "STRICT" );
      if (value__V182) { { START(sink__V171, _M_SH_Function);
          COPY(sink__V171, sub__V173);COPY(sink__V171, sub__V174);COPY(sink__V171, sub__V176);COPY(sink__V171, sub__V177);COPY(sink__V171, sub__V178);COPY(sink__V171, sub__V179);END(sink__V171, _M_SH_Function); }
         }
      else { { START(sink__V171, _M_H_Function);
          COPY(sink__V171, sub__V173);COPY(sink__V171, sub__V174);COPY(sink__V171, sub__V176);COPY(sink__V171, sub__V177);COPY(sink__V171, sub__V178);COPY(sink__V171, sub__V179);END(sink__V171, _M_H_Function); }
         }
    }
    UNLINK_NamedPropertyLink(sink__V171->context, namedP__V180); 
    UNLINK_VariablePropertyLink(sink__V171->context, varP__V181);
    return 1;
  } while (0);
  return 0;
}
...
int step_M_H_Declaration_s1(Sink sink__V183, Term term__V184)
{
  int term__V184_count = LINK_COUNT(term__V184); permitUnusedInt(term__V184_count);
  do {
    /* Contraction rule HEADER-Data. */
    ASSERT(sink__V183->context, !strcmp(SYMBOL(term__V184),  "H-Declaration$1" ));
    ...
    CRSX_CHECK_SORT(sink__V183->context, sub__V185, &sort_M_Reified_xSort); /* sub__V185 = &#11 */
    ...
    NamedPropertyLink namedP__V187 = LINK_NamedPropertyLink(sink__V183->context, NAMED_PROPERTIES(term__V184));
    VariablePropertyLink varP__V188 = LINK_VariablePropertyLink(sink__V183->context, VARIABLE_PROPERTIES(term__V184));
    UNLINK(sink__V183->context, term__V184);
    { START(sink__V183, _M_H_Data);
      COPY(sink__V183, sub__V185);COPY(sink__V183, sub__V186);END(sink__V183, _M_H_Data); }
    UNLINK_NamedPropertyLink(sink__V183->context, namedP__V187); 
    UNLINK_VariablePropertyLink(sink__V183->context, varP__V188);
    return 1;
  } while (0);
  return 0;
}
...
/* FUNCTION H-Function. */
int conBindOffs_M_H_Function[] = {0 , 0 , 0 , 0 , 0 , 0 , 0};
char *nameFun_M_H_Function(Term term) { return  "H-Function" ; }
struct _ConstructionDescriptor descriptor_M_H_Function = {&sort_M_Reified_xVariable, 0, 6, sizeof(STRUCT_Con_M_H_Function), conBindOffs_M_H_Function, &nameFun_M_H_Function, &step_M_H_Function};

int step_M_H_Function(Sink sink__V189, Term term__V190)
{
  int term__V190_count = LINK_COUNT(term__V190); permitUnusedInt(term__V190_count);
  do {
    /* Contraction rule HEADER-H-Function-1. */
    ASSERT(sink__V189->context, !strcmp(SYMBOL(term__V190),  "H-Function" ));
    Term sub__V191 = LINK(sink__V189->context, SUB(term__V190, 0)); int sub__V191_count = term__V190_count*LINK_COUNT(sub__V191); permitUnusedInt(sub__V191_count);
    /* sub__V191 = &#1 */
    Term sub__V192 = SUB(term__V190, 1); int sub__V192_count = term__V190_count*LINK_COUNT(sub__V192); permitUnusedInt(sub__V192_count);
    /* sub__V192 = &#2 */
    Term sub__V193 = LINK(sink__V189->context, SUB(term__V190, 2)); int sub__V193_count = term__V190_count*LINK_COUNT(sub__V193); permitUnusedInt(sub__V193_count);
    /* sub__V193 = &#3 */
    Term sub__V194 = LINK(sink__V189->context, SUB(term__V190, 3)); int sub__V194_count = term__V190_count*LINK_COUNT(sub__V194); permitUnusedInt(sub__V194_count);
    /* sub__V194 = &#4 */
    Term sub__V195 = SUB(term__V190, 4); int sub__V195_count = term__V190_count*LINK_COUNT(sub__V195); permitUnusedInt(sub__V195_count);
    CRSX_CHECK_SORT(sink__V189->context, sub__V195, &sort_M_Reified_xSort); /* sub__V195 = &#5 */
    Term sub__V196 = SUB(term__V190, 5); int sub__V196_count = term__V190_count*LINK_COUNT(sub__V196); permitUnusedInt(sub__V196_count);
    /* sub__V196 = &#6 */
    
    NamedPropertyLink namedP__V197 = LINK_NamedPropertyLink(sink__V189->context, NAMED_PROPERTIES(term__V190));
    VariablePropertyLink varP__V198 = LINK_VariablePropertyLink(sink__V189->context, VARIABLE_PROPERTIES(term__V190));
    UNLINK(sink__V189->context, term__V190);
    { START(sink__V189, _M__sTextCons);
      { START(sink__V189, _M__sTextBreak);
        LITERAL(sink__V189,  "\n" ); END(sink__V189, _M__sTextBreak); }
      { START(sink__V189, _M__sTextCons);
        { START(sink__V189, _M__sTextChars);
          LITERAL(sink__V189,  "/* FUNCTION " ); END(sink__V189, _M__sTextChars); }
        { START(sink__V189, _M__sTextCons);
          { START(sink__V189, _M__sTextEmbed);
            { START(sink__V189, _M_AsText);
              { START(sink__V189, _M_COMMENT_xTOKEN);
                COPY(sink__V189, sub__V191);END(sink__V189, _M_COMMENT_xTOKEN); }
              END(sink__V189, _M_AsText); }
            END(sink__V189, _M__sTextEmbed); }
          { START(sink__V189, _M__sTextCons);
            { START(sink__V189, _M__sTextChars);
              LITERAL(sink__V189,  " HEADER DECLARATIONS. */" ); END(sink__V189, _M__sTextChars); }
            { START(sink__V189, _M__sTextCons);
              { START(sink__V189, _M__sTextBreak);
                LITERAL(sink__V189,  "\n" ); END(sink__V189, _M__sTextBreak); }
              { START(sink__V189, _M__sTextCons);
                { START(sink__V189, _M__sTextEmbed);
                  { START(sink__V189, _M_AsText);
                    { START(sink__V189, _M_MapText_s1);
                      COPY(sink__V189, sub__V194);{ Variable x__V199 = MAKE_BOUND_PROMISCUOUS_VARIABLE(sink__V189->context,"x__V199");
                        Variable binds__V200[1] = {x__V199}; BINDS(sink__V189, 1, binds__V200);
                        { START(sink__V189, _M_H_Form);
                          USE(sink__V189, linkVariable(sink__V189->context, x__V199));
                          END(sink__V189, _M_H_Form); }
                         }
                      END(sink__V189, _M_MapText_s1); }
                    END(sink__V189, _M_AsText); }
                  END(sink__V189, _M__sTextEmbed); }
                { START(sink__V189, _M__sTextCons);
                  { START(sink__V189, _M__sTextChars);
                    LITERAL(sink__V189,  "extern int " ); END(sink__V189, _M__sTextChars); }
                  { START(sink__V189, _M__sTextCons);
                    { START(sink__V189, _M__sTextEmbed);
                      { START(sink__V189, _M_AsText);
                        { START(sink__V189, _M_Step);
                          COPY(sink__V189, sub__V193);END(sink__V189, _M_Step); }
                        END(sink__V189, _M_AsText); }
                      END(sink__V189, _M__sTextEmbed); }
                    { START(sink__V189, _M__sTextCons);
                      { START(sink__V189, _M__sTextChars);
                        LITERAL(sink__V189,  "(Sink,Term);" ); END(sink__V189, _M__sTextChars); }
                      { START(sink__V189, _M__sTextCons);
                        { START(sink__V189, _M__sTextBreak);
                          LITERAL(sink__V189,  "\n" ); END(sink__V189, _M__sTextBreak); }
                        { START(sink__V189, _M__sTextNil);
                          END(sink__V189, _M__sTextNil); }
                        END(sink__V189, _M__sTextCons); }
                      END(sink__V189, _M__sTextCons); }
                    END(sink__V189, _M__sTextCons); }
                  END(sink__V189, _M__sTextCons); }
                END(sink__V189, _M__sTextCons); }
        ...
        END(sink__V189, _M__sTextCons); }
      END(sink__V189, _M__sTextCons); }
    UNLINK_NamedPropertyLink(sink__V189->context, namedP__V197); 
    UNLINK_VariablePropertyLink(sink__V189->context, varP__V198);
    return 1;
  } while (0);
  return 0;
}
  ...
  do {
    ...
    { START(sink__V201, _M__sTextCons);
      ...
      { START(sink__V201, _M__sTextCons);
                                        ...
                                        { START(sink__V201, _M_AsText);
                                          { START(sink__V201, _M_DelayMapText_s1);
                                            {char* str__V208;{ Term term__V209;
                                                { char *value__V210 = getEnvValue(sink__V201->context,  "HEADERS" );
                                                  ...
                                                  { START(sink__V201, _M__sTextEmbed);
                                                    { START(sink__V201, _M_AsText);
                                                      { START(sink__V201, _M_DTOKEN);
                                                        USE(sink__V201, linkVariable(sink__V201->context, x__V212));
                                                        USE(sink__V201, linkVariable(sink__V201->context, x__V213));
        ...
        END(sink__V201, _M__sTextCons); }
      END(sink__V201, _M__sTextCons); }
    UNLINK_NamedPropertyLink(sink__V201->context, namedP__V206); 
    UNLINK_VariablePropertyLink(sink__V201->context, varP__V207);
    return 1;
  } while (0);
  return 0;
}
