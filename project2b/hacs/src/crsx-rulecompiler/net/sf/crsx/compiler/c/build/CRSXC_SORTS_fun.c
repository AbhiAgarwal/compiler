                    ...
                    { START(sink__V1, _M_MapText_s1);
                      COPY(sink__V1, LINK(sink__V1->context, sub__V5));{ Variable x__V8 = MAKE_BOUND_PROMISCUOUS_VARIABLE(sink__V1->context,"x__V8");
                        ...
                        { START(sink__V1, _M_S_Data_Form_s1);
                          USE(sink__V1, linkVariable(sink__V1->context, x__V8));
                                    ...
                                    { START(sink__V1, _M__sTextEmbed);
                                      { START(sink__V1, _M_AsText);
                                        { START(sink__V1, _M_DDescriptor);
                                          USE(sink__V1, linkVariable(sink__V1->context, x__V10));
                                          USE(sink__V1, linkVariable(sink__V1->context, x__V11));
                                          END(sink__V1, _M_DDescriptor); }
                                        END(sink__V1, _M_AsText); }
                                      END(sink__V1, _M__sTextEmbed); }
                                    { START(sink__V1, _M__sTextCons);
                                      { START(sink__V1, _M__sTextChars);
                                              ...
                                              { START(sink__V1, _M__sTextEmbed);
                                                { START(sink__V1, _M_AsText);
                                                  { START(sink__V1, _M_DSTRING);
                                                    USE(sink__V1, linkVariable(sink__V1->context, x__V13));
                                                    USE(sink__V1, linkVariable(sink__V1->context, x__V14));
                                                            ...
                                                            { START(sink__V1, _M__sTextEmbed);
                                                              { START(sink__V1, _M_AsText);
                                                                { START(sink__V1, _M_DMANGLE);
                                                                  USE(sink__V1, linkVariable(sink__V1->context, x__V16));
                                                                  USE(sink__V1, linkVariable(sink__V1->context, x__V17));
...
int step_M_S_Data_s2(Sink sink__V19, Term term__V20)
{
  ...
  do {
    ...
    Term sub__V21 = SUB(term__V20, 0); int sub__V21_count = term__V20_count*LINK_COUNT(sub__V21); permitUnusedInt(sub__V21_count);
    CRSX_CHECK_SORT(sink__V19->context, sub__V21, &sort_M_Reified_xSort); /* sub__V21 = &#11 */
    Term sub__V22 = SUB(term__V20, 1); int sub__V22_count = term__V20_count*LINK_COUNT(sub__V22); permitUnusedInt(sub__V22_count);
    ...
    UNLINK_NamedPropertyLink(sink__V19->context, namedP__V25); 
    UNLINK_VariablePropertyLink(sink__V19->context, varP__V26);
    return 1;
  } while (0);
  return 0;
}
  ...
  do {
    ...
    { START(sink__V27, _M__sTextCons);
      ...
      { START(sink__V27, _M__sTextCons);
                ...
                { START(sink__V27, _M_AsText);
                  { START(sink__V27, _M_DelayMapText_s1);
                    {char* str__V33;{ Term term__V34;
                        { char *value__V35 = getEnvValue(sink__V27->context,  "HEADERS" );
                          ...
                          { START(sink__V27, _M__sTextEmbed);
                            { START(sink__V27, _M_AsText);
                              { START(sink__V27, _M_DTOKEN);
                                USE(sink__V27, linkVariable(sink__V27->context, x__V37));
                                USE(sink__V27, linkVariable(sink__V27->context, x__V38));
                                END(sink__V27, _M_DTOKEN); }
                              END(sink__V27, _M_AsText); }
                            END(sink__V27, _M__sTextEmbed); }
                          { START(sink__V27, _M__sTextCons);
                            { START(sink__V27, _M__sTextChars);
                                  ...
                                  { START(sink__V27, _M_MapText_s1);
                                    COPY(sink__V27, sub__V30);{ Variable x__V40 = MAKE_BOUND_PROMISCUOUS_VARIABLE(sink__V27->context,"x__V40");
                                      ...
                                      { START(sink__V27, _M_S_Declaration);
                                        USE(sink__V27, linkVariable(sink__V27->context, x__V40));
                                        END(sink__V27, _M_S_Declaration); }
                                       }
        ...
        END(sink__V27, _M__sTextCons); }
      END(sink__V27, _M__sTextCons); }
    UNLINK_NamedPropertyLink(sink__V27->context, namedP__V31); 
    UNLINK_VariablePropertyLink(sink__V27->context, varP__V32);
    return 1;
  } while (0);
  return 0;
}
...
int step_M_S_Declaration(Sink sink__V42, Term term__V43)
{
  ...
  switch (choice__V45)
  {
    case Data_M_DATA: { /* Function SORTS-Data$S-Declaration$DATA case DATA */
      ...
      UNLINK_NamedPropertyLink(sink__V42->context, namedP__V49); 
      UNLINK_VariablePropertyLink(sink__V42->context, varP__V50);
      
      return 1;
    break; } case Data_M_FUNCTION: { /* Function SORTS-Function$S-Declaration$FUNCTION case FUNCTION */
      ASSERT(sink__V42->context, !strcmp(SYMBOL(term__V43),  "S-Declaration" ));
      Term sub__V51 = SUB(term__V43, 0); int sub__V51_count = term__V43_count*LINK_COUNT(sub__V51); permitUnusedInt(sub__V51_count);
      ...
      UNLINK_NamedPropertyLink(sink__V42->context, namedP__V59); 
      UNLINK_VariablePropertyLink(sink__V42->context, varP__V60);
      
      return 1;
    break; } case Data_M_POLYMORPHIC: { /* Function SORTS-Polymorphic$S-Declaration$POLYMORPHIC case POLYMORPHIC */
      ASSERT(sink__V42->context, !strcmp(SYMBOL(term__V43),  "S-Declaration" ));
      Term sub__V61 = SUB(term__V43, 0); int sub__V61_count = term__V43_count*LINK_COUNT(sub__V61); permitUnusedInt(sub__V61_count);
      ...
      Variable y__V62 = linkVariable(sink__V42->context, BINDER(sub__V61,0,0)); if (sub__V61_count <= 1) UNBIND(y__V62);
      ...
      { START(sink__V42, _M_S_Declaration_s3);
        { if (!IS_BOUND(y__V62)) { REBIND(linkVariable(sink__V42->context, y__V62));
            ...
            Variable binds__V68[1] = {b__V67}; BINDS(sink__V42, 1, binds__V68);
            {
              ...
              { Sink buf__V70 = ALLOCA_BUFFER(sink__V42->context);
                USE(buf__V70, linkVariable(buf__V70->context, b__V67));
                arg__V69 = BUFFER_TERM(buf__V70); FREE_BUFFER(buf__V70); }
              Variable vars__V71[1] = {y__V62};
              Term args__V72[1] = {arg__V69};
              struct _SubstitutionFrame substitution__V73 = {NULL, 0, 1, vars__V71, args__V72};
              SUBSTITUTE(sink__V42, sub__V63, &substitution__V73); }
                }
           }
        END(sink__V42, _M_S_Declaration_s3); }
      UNLINK_NamedPropertyLink(sink__V42->context, namedP__V64); 
      UNLINK_VariablePropertyLink(sink__V42->context, varP__V65); unlinkVariable(sink__V42->context, y__V62);
...
int step_M_S_Declaration_s3(Sink sink__V74, Term term__V75)
{
  ...
  do {
    ...
    Variable x__V76 = linkVariable(sink__V74->context, BINDER(term__V75,0,0)); if (term__V75_count <= 1) UNBIND(x__V76);
    ...
    UNLINK_NamedPropertyLink(sink__V74->context, namedP__V79); 
    UNLINK_VariablePropertyLink(sink__V74->context, varP__V80); unlinkVariable(sink__V74->context, x__V76);
    return 1;
  } while (0);
  return 0;
}
...
int step_M_S_Declaration_s2(Sink sink__V81, Term term__V82)
{
  ...
  do {
    ...
    Term sub__V83 = SUB(term__V82, 0); int sub__V83_count = term__V82_count*LINK_COUNT(sub__V83); permitUnusedInt(sub__V83_count);
    /* sub__V83 = &#11 */
    Term sub__V84 = SUB(term__V82, 1); int sub__V84_count = term__V82_count*LINK_COUNT(sub__V84); permitUnusedInt(sub__V84_count);
    /* sub__V84 = &#12 */
    Term sub__V85 = SUB(term__V82, 2); int sub__V85_count = term__V82_count*LINK_COUNT(sub__V85); permitUnusedInt(sub__V85_count);
    /* sub__V85 = &#13 */
    Term sub__V86 = SUB(term__V82, 3); int sub__V86_count = term__V82_count*LINK_COUNT(sub__V86); permitUnusedInt(sub__V86_count);
    /* sub__V86 = &#14 */
    Term sub__V87 = SUB(term__V82, 4); int sub__V87_count = term__V82_count*LINK_COUNT(sub__V87); permitUnusedInt(sub__V87_count);
    /* sub__V87 = &#15 */
    Term sub__V88 = SUB(term__V82, 5); int sub__V88_count = term__V82_count*LINK_COUNT(sub__V88); permitUnusedInt(sub__V88_count);
    CRSX_CHECK_SORT(sink__V81->context, sub__V88, &sort_M_Reified_xSort); /* sub__V88 = &#16 */
    Term sub__V89 = SUB(term__V82, 6); int sub__V89_count = term__V82_count*LINK_COUNT(sub__V89); permitUnusedInt(sub__V89_count);
    /* sub__V89 = &#17 */
    ...
    { START(sink__V81, _M__sTextNil); END(sink__V81, _M__sTextNil); } UNLINK_NamedPropertyLink(sink__V81->context, namedP__V90); 
    UNLINK_VariablePropertyLink(sink__V81->context, varP__V91);
    return 1;
  } while (0);
  return 0;
}
...
int step_M_S_Declaration_s1(Sink sink__V92, Term term__V93)
{
  ...
  do {
    ...
    UNLINK_NamedPropertyLink(sink__V92->context, namedP__V96); 
    UNLINK_VariablePropertyLink(sink__V92->context, varP__V97);
    return 1;
  } while (0);
  return 0;
}
...
int step_M_S_Data_Form_s7(Sink sink__V98, Term term__V99)
{
  ...
  do {
    ...
    Term sub__V100 = SUB(term__V99, 0); int sub__V100_count = term__V99_count*LINK_COUNT(sub__V100); permitUnusedInt(sub__V100_count);
    CRSX_CHECK_SORT(sink__V98->context, sub__V100, &sort_M_Reified_xSort); /* sub__V100 = &#21 */
    Term sub__V101 = SUB(term__V99, 1); int sub__V101_count = term__V99_count*LINK_COUNT(sub__V101); permitUnusedInt(sub__V101_count);
    ...
    UNLINK_NamedPropertyLink(sink__V98->context, namedP__V104); 
    UNLINK_VariablePropertyLink(sink__V98->context, varP__V105);
    return 1;
  } while (0);
  return 0;
}
  ...
  do {
    ...
    { START(sink__V106, _M__sTextCons);
      ...
      { START(sink__V106, _M__sTextCons);
        ...
        END(sink__V106, _M__sTextCons); }
      END(sink__V106, _M__sTextCons); }
    UNLINK_NamedPropertyLink(sink__V106->context, namedP__V110); 
    UNLINK_VariablePropertyLink(sink__V106->context, varP__V111);
    return 1;
  } while (0);
  return 0;
}
...
int step_M_S_Data_Form_s6(Sink sink__V112, Term term__V113)
{
  ...
  do {
    ...
    Term sub__V114 = SUB(term__V113, 0); int sub__V114_count = term__V113_count*LINK_COUNT(sub__V114); permitUnusedInt(sub__V114_count);
    /* sub__V114 = &#1 */
    ...
    UNLINK_NamedPropertyLink(sink__V112->context, namedP__V115); 
    UNLINK_VariablePropertyLink(sink__V112->context, varP__V116);
    return 1;
  } while (0);
  return 0;
}
...
int step_M_S_Data_Form_s3(Sink sink__V117, Term term__V118)
{
  ...
  switch (choice__V120)
  {
    case Data_M__sNil: { /* Function SORTS-S-Data-Form-3$S-Data-Form$3$$Nil case $Nil */
      ...
      Term sub__V121 = SUB(term__V118, 0); int sub__V121_count = term__V118_count*LINK_COUNT(sub__V121); permitUnusedInt(sub__V121_count);
      ...
      UNLINK_NamedPropertyLink(sink__V117->context, namedP__V124); 
      UNLINK_VariablePropertyLink(sink__V117->context, varP__V125);
      
      return 1;
    break; } case Data_M__sCons: { /* Function SORTS-S-Data-Form-4$S-Data-Form$3$$Cons case $Cons */
      ASSERT(sink__V117->context, !strcmp(SYMBOL(term__V118),  "S-Data-Form$3" ));
      Term sub__V126 = SUB(term__V118, 0); int sub__V126_count = term__V118_count*LINK_COUNT(sub__V126); permitUnusedInt(sub__V126_count);
      ...
      UNLINK_NamedPropertyLink(sink__V117->context, namedP__V131); 
      UNLINK_VariablePropertyLink(sink__V117->context, varP__V132);
  ...
  do {
    ...
    { START(sink__V133, _M__sTextCons);
      ...
      { START(sink__V133, _M__sTextCons);
                        ...
                        { START(sink__V133, _M__sTextEmbed);
                          { START(sink__V133, _M_AsText);
                            { START(sink__V133, _M_DINTEGER);
                              USE(sink__V133, linkVariable(sink__V133->context, x__V141));
                              USE(sink__V133, linkVariable(sink__V133->context, x__V142));
                              END(sink__V133, _M_DINTEGER); }
                            END(sink__V133, _M_AsText); }
                          END(sink__V133, _M__sTextEmbed); }
        ...
        END(sink__V133, _M__sTextCons); }
      END(sink__V133, _M__sTextCons); }
    UNLINK_NamedPropertyLink(sink__V133->context, namedP__V139); 
    UNLINK_VariablePropertyLink(sink__V133->context, varP__V140);
    return 1;
  } while (0);
  return 0;
}
...
int step_M_S_Data_Form_s1(Sink sink__V144, Term term__V145)
{
  ...
  switch (choice__V147)
  {
    case Data_M_SORT_SET: { /* Function SORTS-S-Data-Form-1$S-Data-Form$1$SORT-SET case SORT-SET */
      ...
      Term sub__V148 = SUB(term__V145, 0); int sub__V148_count = term__V145_count*LINK_COUNT(sub__V148); permitUnusedInt(sub__V148_count);
      ...
      UNLINK_NamedPropertyLink(sink__V144->context, namedP__V153); 
      UNLINK_VariablePropertyLink(sink__V144->context, varP__V154);
    ...
    break; } case Data_M_SORT_ALLOWS_VARIABLES: { /* Function SORTS-S-Data-Form-2$S-Data-Form$1$SORT-ALLOWS-VARIABLES case SORT-ALLOWS-VARIABLES */
      ASSERT(sink__V144->context, !strcmp(SYMBOL(term__V145),  "S-Data-Form$1" ));
      Term sub__V155 = SUB(term__V145, 0); int sub__V155_count = term__V145_count*LINK_COUNT(sub__V155); permitUnusedInt(sub__V155_count);
      ...
      UNLINK_NamedPropertyLink(sink__V144->context, namedP__V157); 
      UNLINK_VariablePropertyLink(sink__V144->context, varP__V158);
      
      return 1;
    break; } case Data_M_FORM: { /* Function SORTS-S-Data-Form-3$S-Data-Form$1$FORM case FORM */
      ASSERT(sink__V144->context, !strcmp(SYMBOL(term__V145),  "S-Data-Form$1" ));
      Term sub__V159 = SUB(term__V145, 0); int sub__V159_count = term__V145_count*LINK_COUNT(sub__V159); permitUnusedInt(sub__V159_count);
      ...
      UNLINK_NamedPropertyLink(sink__V144->context, namedP__V163); 
      UNLINK_VariablePropertyLink(sink__V144->context, varP__V164);
...
int step_M_ComputeSorts(Sink sink__V165, Term term__V166)
{
  ...
  switch (choice__V168)
  {
    case Data_M_CRSX: { /* Function SORTS-Crsx$ComputeSorts$CRSX case CRSX */
      ...
      Term sub__V169 = SUB(term__V166, 0); int sub__V169_count = term__V166_count*LINK_COUNT(sub__V169); permitUnusedInt(sub__V169_count);
      ...
      UNLINK_NamedPropertyLink(sink__V165->context, namedP__V172); 
      UNLINK_VariablePropertyLink(sink__V165->context, varP__V173);
...
int step_M_S_Data(Sink sink__V174, Term term__V175)
{
  ...
  switch (choice__V177)
  {
    case Data_M_SORT: { /* Function SORTS-S-Data-1$S-Data$SORT case SORT */
      ...
      Term sub__V178 = SUB(term__V175, 0); int sub__V178_count = term__V175_count*LINK_COUNT(sub__V178); permitUnusedInt(sub__V178_count);
      ...
      UNLINK_NamedPropertyLink(sink__V174->context, namedP__V182); 
      UNLINK_VariablePropertyLink(sink__V174->context, varP__V183);
      
      return 1;
    break; } case Data_M_SORT_PROPERTY: { /* Function SORTS-S-Data-2$S-Data$SORT-PROPERTY case SORT-PROPERTY */
      ASSERT(sink__V174->context, !strcmp(SYMBOL(term__V175),  "S-Data" ));
      Term sub__V184 = SUB(term__V175, 0); int sub__V184_count = term__V175_count*LINK_COUNT(sub__V184); permitUnusedInt(sub__V184_count);
      ...
      UNLINK_NamedPropertyLink(sink__V174->context, namedP__V189); 
      UNLINK_VariablePropertyLink(sink__V174->context, varP__V190);
