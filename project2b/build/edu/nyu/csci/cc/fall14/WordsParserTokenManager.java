/* WordsParserTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. WordsParserTokenManager.java */
package edu.nyu.csci.cc.fall14;

/** Token Manager. */
@SuppressWarnings("unused")public class WordsParserTokenManager implements WordsParserConstants {
...
private void jjCheckNAddTwoStates(int state1, int state2)
{
   ...
   jjCheckNAdd(state2);
    ...
    /** Constructor. */
    public WordsParserTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public WordsParserTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
